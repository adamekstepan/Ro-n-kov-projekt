...
<section class="show-products">
   ...
   ?>
   <div class="box">
      <div class="price">CZK<span><?= $fetch_products['price']; ?></span>,-</div>
      <img src="uploaded_img/<?= $fetch_products['image']; ?>" alt="">
      <div class="name"><?= $fetch_products['name']; ?></div>
      <div class="flex-btn">
         <a href="admin_product_update.php?update=<?= $fetch_products['id']; ?>" class="option-btn">upravit</a>
         <a href="admin_products.php?delete=<?= $fetch_products['id']; ?>" class="delete-btn" onclick="return confirm('delete this product?');">smazat</a>
      </div>
   </div>
   <?php
         }
      }else{
         echo '<p class="empty">Zatím žádné produkty!</p>';
      }
   ?>
